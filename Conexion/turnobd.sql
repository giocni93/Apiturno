...
--
-- Servidor: localhost
-- Tiempo de generación: 08-03-2016 a las 03:57:18
...
(4, 'tazedwin@gmail.com', 'edwin', 'DÃ­az', '3008982322', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '01', '01', 'ACTIVO'),
...
(17, 5, NULL, 2, '1065650321', 'giocni@gmail.com', 'Gilmar Jose', 'Ocampo Nieves', '322030838', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'APA91bGcPcrOp3FasLazLamFrhWN56hh1P-e9TSxuzpQWuCWtT5_DAGxJHS4uCduJ7dL9ZJWc8_J__YdhocNcr72rX76x8lSjy57', 'ACTIVO', 'INACTIVO'),
...
(104, 2, 'SAN JOSE DE LA MONTAÃ‘A', 'ACTIVO'),
...
(488, 12, 'UNIÃ“N PANAMERICANA', 'ACTIVO'),
(489, 13, 'AYAPEL', 'ACTIVO'),
(490, 13, 'BUENAVISTA', 'ACTIVO'),
(491, 13, 'CANALETE', 'ACTIVO'),
(492, 13, 'CERETÃ‰', 'ACTIVO'),
(493, 13, 'CHIMA', 'ACTIVO'),
(494, 13, 'CHINÃš', 'ACTIVO'),
...
(576, 14, 'NARIÃ‘O', 'ACTIVO'),
(577, 14, 'NEMOCÃ“N', 'ACTIVO'),
(578, 14, 'NILO', 'ACTIVO'),
(579, 14, 'NIMAIMA', 'ACTIVO'),
(580, 14, 'NOCAIMA', 'ACTIVO'),
(581, 14, 'OSPINA PÃ‰REZ', 'ACTIVO'),
(582, 14, 'PACHO', 'ACTIVO'),
(583, 14, 'PAIME', 'ACTIVO'),
(584, 14, 'PANDI', 'ACTIVO'),
...
(600, 14, 'SESQUILÃ‰', 'ACTIVO'),
(601, 14, 'SIBATÃ‰', 'ACTIVO'),
...
(646, 16, 'SAN JOSÃ‰ DEL GUAVIARE', 'ACTIVO'),
...
(774, 21, 'EL PEÃ‘OL', 'ACTIVO'),
(775, 21, 'EL ROSARIO', 'ACTIVO'),
(776, 21, 'EL TABLÃ“N', 'ACTIVO'),
...
(985, 27, 'TONA', 'ACTIVO'),
(986, 27, 'VALLE SAN JOSÃ‰', 'ACTIVO'),
(987, 27, 'VÃ‰LEZ', 'ACTIVO'),
(988, 27, 'VETAS', 'ACTIVO'),
...
(14, 'Arreglar uÃ±as', 'arreglo de uÃ±as', 'ACTIVO'),
...
--
ALTER TABLE `ingresos`
  ADD CONSTRAINT `ingresos_ibfk_1` FOREIGN KEY (`idServicio`) REFERENCES `servicio` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `ingresos_ibfk_2` FOREIGN KEY (`idEmpleado`) REFERENCES `empleado` (`id`) ON UPDATE CASCADE;
